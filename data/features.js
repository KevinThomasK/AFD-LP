export const featureItems = [
  {
    ...
    title: "Personalized Performance Tracking",
    description:
...
export const featureItems2 = [
  {
    ...
    title: "Personalized Performance Tracking",
    description:
      "Our approach goes beyond teaching; we actively track our student's progress. The monthly performance reports provide insights into their strengths and areas for improvement, helping them stay on the right path.",
  },
  {
    id: 2,
    className: "col-lg-6",
    ...
    title: "Expert Career Guidance",
    description:
      "Our experienced counsellors will analyze our students' interests and backgrounds to develop a tailored career plan, helping them find the best colleges and programs that fit their goals.",
  },
  {
    id: 3,
    className: "col-lg-6",
    ...
    title: "Master the Exam Format",
    description:
      "Regularly practising with our mock exams, which replicate the NIFT/NID exam setup, will help our students refine their time management skills and get accustomed to the question styles, ensuring they're exam-ready and self-assured.",
  },
  {
    id: 4,
    className: "col-lg-6",
